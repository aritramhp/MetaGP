...
parser.add_argument('-f','--fwd',dest='fwd', type=str, required=False, help='Path of forward file')
parser.add_argument('-r','--rev',dest='rev', type=str, required=False, help='Path of reverse file')
